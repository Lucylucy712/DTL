...
class ShelLRPT(object):
    ...
    def _get_shel_config(self,config_file_path):
        ...
        var_ver = config.LRPT.VARIANT_DENSE_VERSION
    ...
    def _get_cv_and_data(self):
        ...
        ######### get cv
        if os.path.exists(os.path.join(self.save_folder,"cv_0","train_test_ix.pkl")):
...
if __name__=="__main__":
    ...
    base_config_index = int(sys.argv[1]) # number inside base_config_folder
    ...
    for config_file_index in range(len(config_file_dic)):
